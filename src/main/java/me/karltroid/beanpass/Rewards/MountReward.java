...
public class MountReward implements Reward
{
    ...
    {
        beanPassGUI.loadElement(new VisualElement(beanPassGUI, spherePlacement, distance, xAngle, yAngle, displayScale/2, 2, Material.GLASS_BOTTLE, mount.getId()), beanPassGUI.allLevelRewardElements);
    }
}